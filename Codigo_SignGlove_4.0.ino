...

{
  ...
  if ((ResisPulgar >160 && ResisPulgar <190) && (ResisIndice >540 && ResisIndice <580) && (ResisCorazon >10 && ResisCorazon <100) && (ResisCorazon >10 && ResisCorazon <100)&& (ResisCorazon >10 && ResisCorazon <100) )
  {
    lcd.setCursor(0, 0);
    lcd.print("       ");
    lcd.setCursor(0, 0);
    ...
    delay(2000);
     ...
     if ((ResisPulgar >450 && ResisPulgar <550) && (ResisIndice >10 && ResisIndice <100) && (ResisCorazon >10 && ResisCorazon <100) && (ResisAnular >530 && ResisAnular <540) && ResisMenique >1)
  {
    lcd.setCursor(0, 0);
    lcd.print("       ");
    lcd.setCursor(0, 0);
    ...
    delay(2000);
     ...
     if ((ResisPulgar >450 && ResisPulgar <550) && (ResisIndice >70 && ResisIndice <200) && (ResisCorazon >10 && ResisCorazon <100) && (ResisAnular >530 && ResisAnular <540) && ResisMenique >1)
  {
    lcd.setCursor(0, 0);
    lcd.print("       ");
    lcd.setCursor(0, 0);
    ...
    delay(2000);
     ...
     if ((ResisPulgar >10 && ResisPulgar <50) && (ResisIndice >70 && ResisIndice <100) && (ResisCorazon >10 && ResisCorazon <100)  && (ResisAnular >10 && ResisAnular <100) && ResisMenique >1)
  {
    lcd.setCursor(0, 0);
    lcd.print("       ");
    lcd.setCursor(0, 0);
   ...
   if ((ResisPulgar >200 && ResisPulgar <300) && (ResisIndice >300 && ResisIndice <400) && (ResisCorazon >300 && ResisCorazon <400)  && (ResisAnular >600 && ResisAnular <760) && ResisMenique >1)
  {
    lcd.setCursor(0, 0);
    lcd.print("       ");
    lcd.setCursor(0, 0);
    ...
    if ((ResisPulgar >10 && ResisPulgar <100) && (ResisIndice >300 && ResisIndice <760) && (ResisCorazon >600 && ResisCorazon <760)  && (ResisAnular >600 && ResisAnular <760) )
  {
    lcd.setCursor(0, 0);
    lcd.print("       ");
    lcd.setCursor(0, 0);
    ...
    if ((ResisPulgar <10)  && (ResisIndice >300 && ResisIndice <760) && (ResisCorazon >600 && ResisCorazon <760)  && (ResisAnular >600 && ResisAnular <760) && (ResisMenique >600 && ResisMenique <760)
  {
    lcd.setCursor(0, 0);
    lcd.print("       ");
    lcd.setCursor(0, 0);
    ...
    if ((ResisPulgar <10)  && (ResisIndice <10) && (ResisCorazon <10)  && (ResisAnular <10) && (ResisMenique <10)
  {
    lcd.setCursor(0, 0);
    lcd.print("       ");
    lcd.setCursor(0, 0);
